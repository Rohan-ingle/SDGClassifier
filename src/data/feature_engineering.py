...
class FeatureEngineer:
    ...
    def fit_vectorizer(self, X_train: np.ndarray) -> Tuple[TfidfVectorizer, Any]:
        ...
        try:
            ...
            logger.info("Feature matrix density: %.2f%%", 
                       (X_train_vectorized.nnz / (X_train_vectorized.shape[0] * X_train_vectorized.shape[1])) * 100)
    ...
    def transform_features(self, X: np.ndarray, dataset_name: str = "data") -> Any:
        ...
        try:
            ...
            logger.info("Output matrix density: %.2f%%",
    ...
    def get_top_features_per_class(self, X: Any, y: np.ndarray, 
                                   top_n: int = 10) -> Dict[int, list]:
        """
...
def create_text_features(X_train: np.ndarray, X_val: np.ndarray, X_test: np.ndarray,
                         params: Dict[str, Any]) -> Tuple[Any, Any, Any, FeatureEngineer]:
    """
    ...
    logger.info("Train samples: %d, Val samples: %d, Test samples: %d",
